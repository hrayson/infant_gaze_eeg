...
output_file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_stats_late.txt'
sink(output_file)

#For observation
data <-read.csv(file= '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/obs_saccade_cue_late.csv')
...
data<-data[data$FreqBand =='mu' & (data$WOI =='2000-2500ms'|data$WOI =='2500-3000ms') & (data$Region=='C' | data$Region=='O'| data$Region=='F'| data$Region=='P'),]
...
data_summary$WOIf<-factor(data_summary$WOI, levels=c('2000-2500ms','2500-3000ms'))
...
ggsave(file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_erd_late.png', width=12, height=7)
ggsave(file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_erd_late.eps', width=12, height=7)
...
print(g)
ggsave(file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_erd_all_late.png', width=12, height=10)
ggsave(file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_erd_all_late.eps', width=12, height=10)
...
print(g)
ggsave(file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_erd_c4p4_late.png', width=12, height=7)
ggsave(file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/erd/erd_results/obs/mu_erd_c4p4_late.eps', width=12, height=7)
...
condition1<-lsmeans(basic_model,pairwise~Condition*Age*WOI|Condition*Age)
print(summary(condition1)$contrasts)

condition2<-lsmeans(basic_model,pairwise~Condition*Age*WOI|Condition*WOI)
print(summary(condition2)$contrasts)

condition3<-lsmeans(basic_model,pairwise~Condition*Age*WOI|Age*WOI)
print(summary(condition3)$contrasts)

woi1<-lsmeans(basic_model,pairwise~Cluster*Condition|Cluster)
print(summary(woi1)$contrasts)

cluster3<-lsmeans(basic_model,pairwise~Cluster*Condition|Condition)
