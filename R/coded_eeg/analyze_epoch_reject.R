...
output_file = '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/coded_eeg/num_epoch_reject/stats.txt'
sink(output_file)

# Read num movemnets file
data <-read.csv(file= '/home/jbonaiuto/Dropbox/joint_attention/infant_gaze_eeg/coded_eeg/all_subjects_epoch_reject.csv')
